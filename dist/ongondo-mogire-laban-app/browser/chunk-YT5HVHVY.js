...
`],encapsulation:2,changeDetection:0})}return i})(),Qe=class i{_target;_ngZone;_platform;_containerElement;_triggerElement=null;_isPointerDown=!1;_activeRipples=new Map;_mostRecentTransientRipple=null;_lastTouchStartEvent;_pointerUpEventsRegistered=!1;_containerRect=null;static _eventManager=new Bn;constructor(n,t,e,o,r){this._target=n,this._ngZone=t,this._platform=o,o.isBrowser&&(this._containerElement=q(e)),r&&r.get(Q).load(lr)}fadeInRipple(n,t,e={}){let o=this._containerRect=this._containerRect||this._containerElement.getBoundingClientRect(),r=g(g({},_e),e.animation);e.centered&&(n=o.left+o.width/2,t=o.top+o.height/2);let s=e.radius||cr(n,t,o),l=n-o.left,c=t-o.top,u=r.enterDuration,d=document.createElement("div");d.classList.add("mat-ripple-element"),d.style.left=`${l-s}px`,d.style.top=`${c-s}px`,d.style.height=`${s*2}px`,d.style.width=`${s*2}px`,e.color!=null&&(d.style.backgroundColor=e.color),d.style.transitionDuration=`${u}ms`,this._containerElement.appendChild(d);let b=window.getComputedStyle(d),I=b.transitionProperty,F=b.transitionDuration,T=I==="none"||F==="0s"||F==="0s, 0s"||o.width===0&&o.height===0,O=new Ln(this,d,e,T);d.style.transform="scale3d(1, 1, 1)",O.state=Y.FADING_IN,e.persistent||(this._mostRecentTransientRipple=O);let bt=null;return!T&&(u||r.exitDuration)&&this._ngZone.runOutsideAngular(()=>{let Zn=()=>{bt&&(bt.fallbackTimer=null),clearTimeout($n),this._finishRippleTransition(O)},mn=()=>this._destroyRipple(O),$n=setTimeout(mn,u+100);d.addEventListener("transitionend",Zn),d.addEventListener("transitioncancel",mn),bt={onTransitionEnd:Zn,onTransitionCancel:mn,fallbackTimer:$n}}),this._activeRipples.set(O,bt),(T||!u)&&this._finishRippleTransition(O),O}fadeOutRipple(n){if(n.state===Y.FADING_OUT||n.state===Y.HIDDEN)return;let t=n.element,e=g(g({},_e),n.config.animation);t.style.transitionDuration=`${e.exitDuration}ms`,t.style.opacity="0",n.state=Y.FADING_OUT,(n._animationForciblyDisabledThroughCss||!e.exitDuration)&&this._finishRippleTransition(n)}fadeOutAll(){this._getActiveRipples().forEach(n=>n.fadeOut())}fadeOutAllNonPersistent(){this._getActiveRipples().forEach(n=>{n.config.persistent||n.fadeOut()})}setupTriggerEvents(n){let t=q(n);!this._platform.isBrowser||!t||t===this._triggerElement||(this._removeTriggerEvents(),this._triggerElement=t,mo.forEach(e=>{i._eventManager.addHandler(this._ngZone,e,t,this)}))}handleEvent(n){n.type==="mousedown"?this._onMousedown(n):n.type==="touchstart"?this._onTouchStart(n):this._onPointerUp(),this._pointerUpEventsRegistered||(this._ngZone.runOutsideAngular(()=>{ho.forEach(t=>{this._triggerElement.addEventListener(t,this,uo)})}),this._pointerUpEventsRegistered=!0)}_finishRippleTransition(n){n.state===Y.FADING_IN?this._startFadeOutTransition(n):n.state===Y.FADING_OUT&&this._destroyRipple(n)}_startFadeOutTransition(n){let t=n===this._mostRecentTransientRipple,{persistent:e}=n.config;n.state=Y.VISIBLE,!e&&(!t||!this._isPointerDown)&&n.fadeOut()}_destroyRipple(n){let t=this._activeRipples.get(n)??null;this._activeRipples.delete(n),this._activeRipples.size||(this._containerRect=null),n===this._mostRecentTransientRipple&&(this._mostRecentTransientRipple=null),n.state=Y.HIDDEN,t!==null&&(n.element.removeEventListener("transitionend",t.onTransitionEnd),n.element.removeEventListener("transitioncancel",t.onTransitionCancel),t.fallbackTimer!==null&&clearTimeout(t.fallbackTimer)),n.element.remove()}_onMousedown(n){let t=ae(n),e=this._lastTouchStartEvent&&Date.now()<this._lastTouchStartEvent+sr;!this._target.rippleDisabled&&!t&&!e&&(this._isPointerDown=!0,this.fadeInRipple(n.clientX,n.clientY,this._target.rippleConfig))}_onTouchStart(n){if(!this._target.rippleDisabled&&!se(n)){this._lastTouchStartEvent=Date.now(),this._isPointerDown=!0;let t=n.changedTouches;if(t)for(let e=0;e<t.length;e++)this.fadeInRipple(t[e].clientX,t[e].clientY,this._target.rippleConfig)}}_onPointerUp(){this._isPointerDown&&(this._isPointerDown=!1,this._getActiveRipples().forEach(n=>{let t=n.state===Y.VISIBLE||n.config.terminateOnPointerUp&&n.state===Y.FADING_IN;!n.config.persistent&&t&&n.fadeOut()}))}_getActiveRipples(){return Array.from(this._activeRipples.keys())}_removeTriggerEvents(){let n=this._triggerElement;n&&(mo.forEach(t=>i._eventManager.removeHandler(t,n,this)),this._pointerUpEventsRegistered&&(ho.forEach(t=>n.removeEventListener(t,this,uo)),this._pointerUpEventsRegistered=!1))}};function cr(i,n,t){let e=Math.max(Math.abs(i-t.left),Math.abs(i-t.right)),o=Math.max(Math.abs(n-t.top),Math.abs(n-t.bottom));return Math.sqrt(e*e+o*o)}var po=new C("mat-ripple-global-options");var dr={capture:!0},ur=["focus","mousedown","mouseenter","touchstart"],jn="mat-ripple-loader-uninitialized",Vn="mat-ripple-loader-class-name",fo="mat-ripple-loader-centered",Je="mat-ripple-loader-disabled",bo=(()=>{class i{_document=a(D);_animationsDisabled=J();_globalRippleOptions=a(po,{optional:!0});_platform=a(A);_ngZone=a(E);_injector=a(w);_eventCleanups;_hosts=new Map;constructor(){let t=a(X).createRenderer(null,null);this._eventCleanups=this._ngZone.runOutsideAngular(()=>ur.map(e=>t.listen(this._document,e,this._onInteraction,dr)))}ngOnDestroy(){let t=this._hosts.keys();for(let e of t)this.destroyRipple(e);this._eventCleanups.forEach(e=>e())}configureRipple(t,e){t.setAttribute(jn,this._globalRippleOptions?.namespace??""),(e.className||!t.hasAttribute(Vn))&&t.setAttribute(Vn,e.className||""),e.centered&&t.setAttribute(fo,""),e.disabled&&t.setAttribute(Je,"")}setDisabled(t,e){let o=this._hosts.get(t);o?(o.target.rippleDisabled=e,!e&&!o.hasSetUpEvents&&(o.hasSetUpEvents=!0,o.renderer.setupTriggerEvents(t))):e?t.setAttribute(Je,""):t.removeAttribute(Je)}_onInteraction=t=>{let e=N(t);if(e instanceof HTMLElement){let o=e.closest(`[${jn}="${this._globalRippleOptions?.namespace??""}"]`);o&&this._createRipple(o)}};_createRipple(t){if(!this._document||this._hosts.has(t))return;t.querySelector(".mat-ripple")?.remove();let e=this._document.createElement("span");e.classList.add("mat-ripple",t.getAttribute(Vn)),t.append(e);let o=this._globalRippleOptions,r=this._animationsDisabled?0:o?.animation?.enterDuration??_e.enterDuration,s=this._animationsDisabled?0:o?.animation?.exitDuration??_e.exitDuration,l={rippleDisabled:this._animationsDisabled||o?.disabled||t.hasAttribute(Je),rippleConfig:{centered:t.hasAttribute(fo),terminateOnPointerUp:o?.terminateOnPointerUp,animation:{enterDuration:r,exitDuration:s}}},c=new Qe(l,this._ngZone,e,this._platform,this._injector),u=!l.rippleDisabled;u&&c.setupTriggerEvents(t),this._hosts.set(t,{target:l,renderer:c,hasSetUpEvents:u}),t.removeAttribute(jn)}destroyRipple(t){let e=this._hosts.get(t);e&&(e.renderer._removeTriggerEvents(),this._hosts.delete(t))}static \u0275fac=function(e){return new(e||i)};static \u0275prov=m({token:i,factory:i.\u0275fac,providedIn:"root"})}return i})();var go=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275cmp=p({type:i,selectors:[["structural-styles"]],decls:0,vars:0,template:function(e,o){},styles:[`.mat-focus-indicator {
  position: relative;
}
...
`],encapsulation:2,changeDetection:0})}return i})();var mr=new C("MAT_BUTTON_CONFIG");function _o(i){return i==null?void 0:ui(i)}var vo=(()=>{class i{_elementRef=a(M);_ngZone=a(E);_animationsDisabled=J();_config=a(mr,{optional:!0});_focusMonitor=a(me);_cleanupClick;_renderer=a(yt);_rippleLoader=a(bo);_isAnchor;_isFab=!1;color;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=t,this._updateRippleDisabled()}_disableRipple=!1;get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._updateRippleDisabled()}_disabled=!1;ariaDisabled;disabledInteractive;tabIndex;set _tabindex(t){this.tabIndex=t}constructor(){a(Q).load(go);let t=this._elementRef.nativeElement;this._isAnchor=t.tagName==="A",this.disabledInteractive=this._config?.disabledInteractive??!1,this.color=this._config?.color??null,this._rippleLoader?.configureRipple(t,{className:"mat-mdc-button-ripple"})}ngAfterViewInit(){this._focusMonitor.monitor(this._elementRef,!0),this._isAnchor&&this._setupAsAnchor()}ngOnDestroy(){this._cleanupClick?.(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement)}focus(t="program",e){t?this._focusMonitor.focusVia(this._elementRef.nativeElement,t,e):this._elementRef.nativeElement.focus(e)}_getAriaDisabled(){return this.ariaDisabled!=null?this.ariaDisabled:this._isAnchor?this.disabled||null:this.disabled&&this.disabledInteractive?!0:null}_getDisabledAttribute(){return this.disabledInteractive||!this.disabled?null:!0}_updateRippleDisabled(){this._rippleLoader?.setDisabled(this._elementRef.nativeElement,this.disableRipple||this.disabled)}_getTabIndex(){return this._isAnchor?this.disabled&&!this.disabledInteractive?-1:this.tabIndex:this.tabIndex}_setupAsAnchor(){this._cleanupClick=this._ngZone.runOutsideAngular(()=>this._renderer.listen(this._elementRef.nativeElement,"click",t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())}))}static \u0275fac=function(e){return new(e||i)};static \u0275dir=P({type:i,hostAttrs:[1,"mat-mdc-button-base"],hostVars:13,hostBindings:function(e,o){e&2&&(it("disabled",o._getDisabledAttribute())("aria-disabled",o._getAriaDisabled())("tabindex",o._getTabIndex()),ci(o.color?"mat-"+o.color:""),z("mat-mdc-button-disabled",o.disabled)("mat-mdc-button-disabled-interactive",o.disabledInteractive)("mat-unthemed",!o.color)("_mat-animation-noopable",o._animationsDisabled))},inputs:{color:"color",disableRipple:[2,"disableRipple","disableRipple",lt],disabled:[2,"disabled","disabled",lt],ariaDisabled:[2,"aria-disabled","ariaDisabled",lt],disabledInteractive:[2,"disabledInteractive","disabledInteractive",lt],tabIndex:[2,"tabIndex","tabIndex",_o],_tabindex:[2,"tabindex","_tabindex",_o]}})}return i})();var yo=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=S({type:i});static \u0275inj=k({imports:[U]})}return i})();var hr=["matButton",""],pr=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]]],fr=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]"];var wo=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),xo=(()=>{class i extends vo{get appearance(){return this._appearance}set appearance(t){this.setAppearance(t||this._config?.defaultAppearance||"text")}_appearance=null;constructor(){super();let t=br(this._elementRef.nativeElement);t&&this.setAppearance(t)}setAppearance(t){if(t===this._appearance)return;let e=this._elementRef.nativeElement.classList,o=this._appearance?wo.get(this._appearance):null,r=wo.get(t);o&&e.remove(...o),e.add(...r),this._appearance=t}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=p({type:i,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[H],attrs:hr,ngContentSelectors:fr,decls:7,vars:4,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(e,o){e&1&&(Oe(pr),ie(0,"span",0),Ft(1),B(2,"span",1),Ft(3,1),j(),Ft(4,2),ie(5,"span",2)(6,"span",3)),e&2&&z("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab)},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2,changeDetection:0})}return i})();function br(i){return i.hasAttribute("mat-raised-button")?"elevated":i.hasAttribute("mat-stroked-button")?"outlined":i.hasAttribute("mat-flat-button")?"filled":i.hasAttribute("mat-button")?"text":null}var Co=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=S({type:i});static \u0275inj=k({imports:[yo,U]})}return i})();function gr(i,n){if(i&1){let t=Re();f(0,"div",1)(1,"button",2),V("click",function(){Qt(t);let o=Pt();return Jt(o.action())}),y(2),h()()}if(i&2){let t=Pt();v(2),gn(" ",t.data.action," ")}}var _r=["label"];function vr(i,n){}var yr=Math.pow(2,31)-1,ve=class{_overlayRef;instance;containerInstance;_afterDismissed=new _;_afterOpened=new _;_onAction=new _;_durationTimeoutId;_dismissedByAction=!1;constructor(n,t){this._overlayRef=t,this.containerInstance=n,n._onExit.subscribe(()=>this._finishDismiss())}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId)}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=!0,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId)}closeWithAction(){this.dismissWithAction()}_dismissAfter(n){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(n,yr))}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete())}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=!1}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},Eo=new C("MatSnackBarData"),Zt=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},wr=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275dir=P({type:i,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return i})(),xr=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275dir=P({type:i,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return i})(),Cr=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275dir=P({type:i,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return i})(),Do=(()=>{class i{snackBarRef=a(ve);data=a(Eo);constructor(){}action(){this.snackBarRef.dismissWithAction()}get hasAction(){return!!this.data.action}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=p({type:i,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(e,o){e&1&&(f(0,"div",0),y(1),h(),wt(2,gr,3,1,"div",1)),e&2&&(v(),gn(" ",o.data.message,`
`),v(),xt(o.hasAction?2:-1))},dependencies:[xo,wr,xr,Cr],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
...
`],encapsulation:2})}return i})(),To="--mat-dialog-transition-duration";function Io(i){return i==null?null:typeof i=="number"?i:i.endsWith("ms")?de(i.substring(0,i.length-2)):i.endsWith("s")?de(i.substring(0,i.length-1))*1e3:i==="0"?0:null}var rn=(function(i){return i[i.OPEN=0]="OPEN",i[i.CLOSING=1]="CLOSING",i[i.CLOSED=2]="CLOSED",i})(rn||{}),At=class{_ref;_config;_containerInstance;componentInstance;componentRef=null;disableClose;id;_afterOpened=new Ce(1);_beforeClosed=new Ce(1);_result;_closeFallbackTimeout;_state=rn.OPEN;_closeInteractionType;constructor(n,t,e){this._ref=n,this._config=t,this._containerInstance=e,this.disableClose=t.disableClose,this.id=n.id,n.addPanelClass("mat-mdc-dialog-panel"),e._animationStateChanged.pipe(et(o=>o.state==="opened"),st(1)).subscribe(()=>{this._afterOpened.next(),this._afterOpened.complete()}),e._animationStateChanged.pipe(et(o=>o.state==="closed"),st(1)).subscribe(()=>{clearTimeout(this._closeFallbackTimeout),this._finishDialogClose()}),n.overlayRef.detachments().subscribe(()=>{this._beforeClosed.next(this._result),this._beforeClosed.complete(),this._finishDialogClose()}),Jn(this.backdropClick(),this.keydownEvents().pipe(et(o=>o.keyCode===27&&!this.disableClose&&!He(o)))).subscribe(o=>{this.disableClose||(o.preventDefault(),Br(this,o.type==="keydown"?"keyboard":"mouse"))})}close(n){let t=this._config.closePredicate;t&&!t(n,this._config,this.componentInstance)||(this._result=n,this._containerInstance._animationStateChanged.pipe(et(e=>e.state==="closing"),st(1)).subscribe(e=>{this._beforeClosed.next(n),this._beforeClosed.complete(),this._ref.overlayRef.detachBackdrop(),this._closeFallbackTimeout=setTimeout(()=>this._finishDialogClose(),e.totalTime+100)}),this._state=rn.CLOSING,this._containerInstance._startExitAnimation())}afterOpened(){return this._afterOpened}afterClosed(){return this._ref.closed}beforeClosed(){return this._beforeClosed}backdropClick(){return this._ref.backdropClick}keydownEvents(){return this._ref.keydownEvents}updatePosition(n){let t=this._ref.config.positionStrategy;return n&&(n.left||n.right)?n.left?t.left(n.left):t.right(n.right):t.centerHorizontally(),n&&(n.top||n.bottom)?n.top?t.top(n.top):t.bottom(n.bottom):t.centerVertically(),this._ref.updatePosition(),this}updateSize(n="",t=""){return this._ref.updateSize(n,t),this}addPanelClass(n){return this._ref.addPanelClass(n),this}removePanelClass(n){return this._ref.removePanelClass(n),this}getState(){return this._state}_finishDialogClose(){this._state=rn.CLOSED,this._ref.close(this._result,{focusOrigin:this._closeInteractionType}),this.componentInstance=null}};function Br(i,n,t){return i._closeInteractionType=n,i.close(t)}var we=new C("MatMdcDialogData"),jr=new C("mat-mdc-dialog-default-options"),Vr=new C("mat-mdc-dialog-scroll-strategy",{providedIn:"root",factory:()=>{let i=a(w);return()=>Gt(i)}}),Xn=(()=>{class i{_defaultOptions=a(jr,{optional:!0});_scrollStrategy=a(Vr);_parentDialog=a(i,{optional:!0,skipSelf:!0});_idGenerator=a(Z);_injector=a(w);_dialog=a(Yn);_animationsDisabled=J();_openDialogsAtThisLevel=[];_afterAllClosedAtThisLevel=new _;_afterOpenedAtThisLevel=new _;dialogConfigClass=an;_dialogRefConstructor;_dialogContainerType;_dialogDataToken;get openDialogs(){return this._parentDialog?this._parentDialog.openDialogs:this._openDialogsAtThisLevel}get afterOpened(){return this._parentDialog?this._parentDialog.afterOpened:this._afterOpenedAtThisLevel}_getAfterAllClosed(){let t=this._parentDialog;return t?t._getAfterAllClosed():this._afterAllClosedAtThisLevel}afterAllClosed=Ee(()=>this.openDialogs.length?this._getAfterAllClosed():this._getAfterAllClosed().pipe(gt(void 0)));constructor(){this._dialogRefConstructor=At,this._dialogContainerType=Lr,this._dialogDataToken=we}open(t,e){let o;e=g(g({},this._defaultOptions||new an),e),e.id=e.id||this._idGenerator.getId("mat-mdc-dialog-"),e.scrollStrategy=e.scrollStrategy||this._scrollStrategy();let r=this._dialog.open(t,Kt(g({},e),{positionStrategy:pt(this._injector).centerHorizontally().centerVertically(),disableClose:!0,closePredicate:void 0,closeOnDestroy:!1,closeOnOverlayDetachments:!1,disableAnimations:this._animationsDisabled||e.enterAnimationDuration?.toLocaleString()==="0"||e.exitAnimationDuration?.toString()==="0",container:{type:this._dialogContainerType,providers:()=>[{provide:this.dialogConfigClass,useValue:e},{provide:ft,useValue:e}]},templateContext:()=>({dialogRef:o}),providers:(s,l,c)=>(o=new this._dialogRefConstructor(s,e,c),o.updatePosition(e?.position),[{provide:this._dialogContainerType,useValue:c},{provide:this._dialogDataToken,useValue:l.data},{provide:this._dialogRefConstructor,useValue:o}])}));return o.componentRef=r.componentRef,o.componentInstance=r.componentInstance,this.openDialogs.push(o),this.afterOpened.next(o),o.afterClosed().subscribe(()=>{let s=this.openDialogs.indexOf(o);s>-1&&(this.openDialogs.splice(s,1),this.openDialogs.length||this._getAfterAllClosed().next())}),o}closeAll(){this._closeDialogs(this.openDialogs)}getDialogById(t){return this.openDialogs.find(e=>e.id===t)}ngOnDestroy(){this._closeDialogs(this._openDialogsAtThisLevel),this._afterAllClosedAtThisLevel.complete(),this._afterOpenedAtThisLevel.complete()}_closeDialogs(t){let e=t.length;for(;e--;)t[e].close()}static \u0275fac=function(e){return new(e||i)};static \u0275prov=m({token:i,factory:i.\u0275fac,providedIn:"root"})}return i})();var sn=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=S({type:i});static \u0275inj=k({providers:[Xn],imports:[Ro,kt,at,U]})}return i})();var ln=class i{dialogRef=a(At);data=a(we);static \u0275fac=function(t){return new(t||i)};static \u0275cmp=p({type:i,selectors:[["app-confirm-dialog"]],decls:10,vars:2,consts:[[1,"p-6"],[1,"text-xl","font-bold","mb-2","text-gray-800"],[1,"text-gray-600","mb-6"],[1,"flex","justify-end","gap-3"],[1,"px-4","py-2","border","rounded-md","hover:bg-gray-50","transition-colors",3,"click"],[1,"bg-red-600","text-white","px-4","py-2","rounded-md","hover:bg-red-700","transition-colors","shadow-sm",3,"click"]],template:function(t,e){t&1&&(B(0,"div",0)(1,"h2",1),y(2),j(),B(3,"p",2),y(4),j(),B(5,"div",3)(6,"button",4),It("click",function(){return e.dialogRef.close(!1)}),y(7," Cancel "),j(),B(8,"button",5),It("click",function(){return e.dialogRef.close(!0)}),y(9," Delete "),j()()()),t&2&&(v(2),Bt(e.data.title),v(2),Bt(e.data.message))},dependencies:[sn],encapsulation:2})};var cn=class i{fb=a(Be);userService=a(tt);snackBar=a(St);dialogRef=a(At);data=a(we);editForm=this.fb.group({name:[this.data.name,[ot.required]],email:[this.data.email,[ot.required,ot.email]]});onSave(){this.editForm.valid&&this.userService.update(this.data.id,this.editForm.value).subscribe({next:()=>{this.snackBar.open("User updated successfully!","OK",{duration:3e3}),this.dialogRef.close(!0)},error:()=>this.snackBar.open("Update failed","Close",{duration:3e3})})}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=p({type:i,selectors:[["app-user-edit-dialog"]],decls:17,vars:2,consts:[[1,"p-6"],[1,"text-xl","font-bold","mb-4"],[3,"ngSubmit","formGroup"],[1,"mb-4"],[1,"block","text-sm","font-medium","text-gray-700"],["formControlName","name","type","text",1,"mt-1","w-full","p-2","border","rounded-md","outline-none","focus:ring-2","focus:ring-blue-500"],[1,"mb-6"],["formControlName","email","type","email",1,"mt-1","w-full","p-2","border","rounded-md","outline-none","focus:ring-2","focus:ring-blue-500"],[1,"flex","justify-end","gap-3"],["type","button",1,"px-4","py-2","border","rounded-md","hover:bg-gray-50",3,"click"],["type","submit",1,"bg-blue-600","text-white","px-4","py-2","rounded-md","hover:bg-blue-700","disabled:bg-gray-300",3,"disabled"]],template:function(t,e){t&1&&(f(0,"div",0)(1,"h2",1),y(2,"Edit User"),h(),f(3,"form",2),V("ngSubmit",function(){return e.onSave()}),f(4,"div",3)(5,"label",4),y(6,"Name"),h(),L(7,"input",5),h(),f(8,"div",6)(9,"label",4),y(10,"Email"),h(),L(11,"input",7),h(),f(12,"div",8)(13,"button",9),V("click",function(){return e.dialogRef.close()}),y(14,"Cancel"),h(),f(15,"button",10),y(16," Update Changes "),h()()()()),t&2&&(v(3),W("formGroup",e.editForm),v(12),W("disabled",e.editForm.invalid))},dependencies:[sn,Ut,Fe,Vt,zt,Pe,Le,Ne],encapsulation:2})};function zr(i,n){i&1&&(f(0,"div",2),L(1,"div",3),h())}var dn=class i{userService=a(tt);searchControl=new vi("");isLoading=K(!1);constructor(){this.searchControl.valueChanges.pipe(De(400),qt(),_t(()=>this.isLoading.set(!0)),fn(n=>this.userService.loadAll(n||"").pipe(ti(()=>this.isLoading.set(!1)))),en()).subscribe()}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=p({type:i,selectors:[["app-user-search"]],decls:3,vars:2,consts:[[1,"relative","max-w-md"],["type","text","placeholder","Search users...",1,"w-full","px-4","py-2","border","border-secondary","rounded-none","focus:ring-2","focus:ring-green-500","outline-none","shadow-sm",3,"formControl"],[1,"absolute","right-3","top-2.5"],[1,"animate-spin","h-5","w-5","border-2","border-green-500","border-t-transparent","rounded-full"]],template:function(t,e){t&1&&(f(0,"div",0),L(1,"input",1),wt(2,zr,2,0,"div",2),h()),t&2&&(v(),W("formControl",e.searchControl),v(),xt(e.isLoading()?2:-1))},dependencies:[Ut,Vt,zt,yi],encapsulation:2})};var Ur=["class","page"],un=class i{destroyRef=a(te);dialog=a(Xn);snackBar=a(St);userService=a(tt);users=this.userService.users;ngOnInit(){this.userService.loadAll().pipe(en(this.destroyRef)).subscribe()}onDelete(n){this.dialog.open(ln,{width:"350px",data:{title:"Delete User",message:`Are you sure you want to delete ${n.name}? This action cannot be undone.`}}).afterClosed().subscribe(e=>{e&&this.userService.delete(n.id).subscribe({next:()=>{this.snackBar.open("User deleted successfully","OK",{duration:3e3,panelClass:["delete-snackbar"]})},error:()=>this.snackBar.open("Error deleting user","Close")})})}onEdit(n){this.dialog.open(cn,{width:"400px",data:n}).afterClosed().subscribe(e=>{})}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=p({type:i,selectors:[["app-users",8,"page"]],attrs:Ur,decls:8,vars:1,consts:[[1,"py-3","flex","justify-between"],[1,"flex","gap-3"],["routerLink","/users/add",1,"bg-primary","hover:bg-secondary","text-white","px-4","py-2","rounded-lg","transition-colors","rounded-none","w-[100px]","h-[48px]","cursor-pointer"],["routerLink","/users/add",1,"hover:border-2","text-red-700","px-4","py-2","rounded-lg","transition-colors","rounded-none","w-[100px]","h-[48px]","cursor-pointer"],[3,"deleteUser","editUser","usersList"]],template:function(t,e){t&1&&(f(0,"nav",0),L(1,"app-user-search"),f(2,"div",1)(3,"button",2),y(4," Add User "),h(),f(5,"button",3),y(6," Log Out "),h()()(),f(7,"app-users-list",4),V("deleteUser",function(r){return e.onDelete(r)})("editUser",function(r){return e.onEdit(r)}),h()),t&2&&(v(7),W("usersList",e.users()))},dependencies:[on,Ie,dn],encapsulation:2})};var Vu=[{path:"",component:un},{path:"add",component:tn}];export{Vu as USERS_ROUTES};
